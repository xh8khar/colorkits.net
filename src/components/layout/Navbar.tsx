            ...
            <div className="pt-2 flex items-center gap-2">
              ...
              {socialLinks.map(link => (
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setMenuOpen(false)}
                  className="p-1.5 rounded text-slate-500 dark:text-slate-400 hover:text-rose-500 dark:hover:text-rose-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
